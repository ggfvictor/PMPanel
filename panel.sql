...
) ENGINE=InnoDB AUTO_INCREMENT=564763 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='在线ip';
...
CREATE TABLE `config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=303 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='面板配置';
...
CREATE TABLE `detect_list` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='审计规则';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='资金明细表';
...
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单记录';
...
CREATE TABLE `permission` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='权限';
...
CREATE TABLE `plan` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='套餐';
...
CREATE TABLE `ss_node` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='节点表';
...
) ENGINE=InnoDB AUTO_INCREMENT=31377 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户表';
...
INSERT INTO `panel`.`config`(`id`, `name`, `value`) VALUES (105, 'enableWithdraw', 'false');
INSERT INTO `panel`.`config`(`id`, `name`, `value`) VALUES (106, 'minWithdraw', '50');
INSERT INTO `panel`.`config`(`id`, `name`, `value`) VALUES (107, 'withdrawRate', '0.15');
INSERT INTO `panel`.`config`(`id`, `name`, `value`) VALUES (201, 'alipay', 'none');
INSERT INTO `panel`.`config`(`id`, `name`, `value`) VALUES (202, 'wxpay', 'none');
INSERT INTO `panel`.`config`(`id`, `name`, `value`) VALUES (203, 'alipayConfig', '{\"appId\":\"\",\"pId\":\"\",\"isCertMode\":false,\"appPrivateKey\":\"\",\"alipayPublicKey\":\"\",\"appCertPath\":\"\",\"alipayCertPath\":\"\",\"alipayRootCertPath\":\"\",\"serverUrl\":\"https://openapi.alipay.com/gateway.do\",\"domain\":\"http://127.0.0.1\",\"web\":false,\"wap\":false,\"f2f\":false}');
INSERT INTO `panel`.`config`(`id`, `name`, `value`) VALUES (301, 'muSuffix', 'download.windowsupdate.com');
INSERT INTO `panel`.`config`(`id`, `name`, `value`) VALUES (302, 'userTrafficLogLimitDays', '3');

INSERT INTO `panel`.`permission`(`id`, `role`, `permission`) VALUES (1, 'user', 'user');
INSERT INTO `panel`.`permission`(`id`, `role`, `permission`) VALUES (2, 'admin', 'admin');

INSERT INTO `panel`.`schedule`(`id`, `bean_name`, `method_name`, `method_params`, `cron_expression`, `remark`, `job_status`, `created_time`, `update_time`) VALUES (1, 'dailyJobTaskService', 'syncTraffic', NULL, '0 0 0 * * *', '每日同步流量', 1, '2020-11-11 10:31:52', '2020-11-25 20:42:00');
INSERT INTO `panel`.`schedule`(`id`, `bean_name`, `method_name`, `method_params`, `cron_expression`, `remark`, `job_status`, `created_time`, `update_time`) VALUES (2, 'dailyJobTaskService', 'cleanDB', NULL, '0 0 0 * * *', '每日清理数据库', 1, '2020-11-11 10:31:52', '2020-11-25 20:42:05');
INSERT INTO `panel`.`schedule`(`id`, `bean_name`, `method_name`, `method_params`, `cron_expression`, `remark`, `job_status`, `created_time`, `update_time`) VALUES (3, 'checkJobTaskService', 'checkJob', NULL, '0 * * * * ?', '检查任务', 1, '2020-11-12 20:35:55', '2020-11-27 10:56:48');
INSERT INTO `panel`.`schedule`(`id`, `bean_name`, `method_name`, `method_params`, `cron_expression`, `remark`, `job_status`, `created_time`, `update_time`) VALUES (4, 'checkOrderJobTaskService', 'checkOrderJob', NULL, '*/5 * * * * ?', '支付宝主动查单', 1, '2020-12-17 22:30:17', NULL);
